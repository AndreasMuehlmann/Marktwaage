...
def get_closesed_weight(searched_weight, index_previous_closesed_weight):
...
def main():
    ...
    for task in range(6):
        ...
        with open(f'marktwaage_results{task}.txt', 'w') as file:
            ...
            index_previous_closesed_weight = get_index_first_0()

            for searched_weight in range(10, 10010, 10):
                closesed_weight, index_previous_closesed_weight = get_closesed_weight(searched_weight, index_previous_closesed_weight)
